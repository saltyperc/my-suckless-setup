/*multiple view-shift functionalities for DWM improved - Kaidon Clark*/
void
...
/* send a window to the next/prev tag that has a client, else it moves it to the next/prev one. */
void
